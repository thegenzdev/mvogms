                ...
                <div class="col-md-8">
                    <form action="" id="checkout-form">
                        <div class="form-group">
                            <label for="delivery_address" class="control-label">Delivery Address and phone number</label>
                        ...
                        <div class="form-group text-right">
                            <a href="login.php"><button class="btn btn-flat btn-default btn-sm bg-navy">Place Order</button></a>
                        </div>
                    </form>
                </div>
                <div class="col-md-4">
