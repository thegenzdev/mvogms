      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
               | 
              <a href="./login.php" class="mx-2 text-light text-decoration-none font-weight-bolder"><b>User Login</b></a> | 
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="city-real-estate/contact.html" class="nav-link">Carpenter Registration</a>
              </li>
              <li class="nav-item">
